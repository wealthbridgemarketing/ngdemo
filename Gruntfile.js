module.exports = function(grunt) {
  ...
  var appjsSrcDef = [
    'services/*.js', 'services/base/**/*.js', 'services/core/**/*.js', 'services/dash/**/*.js', 'services/util/**/*.js',
    'components/**/*.js', 'sections/**/*.js', 'assets/js/**/*.js'
  ];
...
// CONCAT - combines multiple files into one
    concat: {
      ...
      vendorcss: {
        options: { separator: '\n' },
        files: [{
          src: [bowerPath+'bootstrap/dist/css/bootstrap.min.css',
      ...
      vendorjs: {
        ...
        files: [{
          src: [bowerPath+'angular/angular.js', //.min
...
// COPY - Copy files and folders
    copy: {
      ...
      vendor: {
        files: [
          // bootstrap fonts
          {expand: true, flatten: true, src: [bowerPath+'bootstrap/dist/fonts/*'], dest: 'dist/assets/fonts/', filter: 'isFile'}
        ]
      }
    },
